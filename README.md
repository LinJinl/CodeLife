...
它持续观察你的修炼数据，从每一次对话中提炼认知，积累一份专属于你的记忆：你的学习节律、你反复出现的卡点、你擅长的方向、你已经沉淀过的能力卡……这些都不会消失。对话越多，它越了解你。
...
| 技能卡 | 已确认的可复用能力卡（场景 / 步骤 / 清单 / 反例） | 明确保存或候选晋升 |
| 候选记忆 | 自动观察到的偏好、能力卡等 | 先进入候选区，确认后晋升 |
...
**写操作（需确认）** — 收藏文章到藏经阁、创建/更新誓约、记录可复用能力卡
...
![器灵·青霄 对话示例](today_what_to_do.png)
...
| 技能卡提炼 | 有未处理对话时 / 手动 POST `/api/spirit/skills` | 先提炼为能力卡候选，写入 `content/spirit/candidates/` |
